...
export class AdminDeliveryEndereOsService {
     ...
     * @throws ApiError
     */
    public listarEnderecosAdminApiDeliveryAdminEnderecosClienteClienteIdGet(
        clienteId: number,
    ): CancelablePromise<Array<EnderecoOut>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/delivery/admin/enderecos/cliente/{cliente_id}',
            path: {
     ...
     * @throws ApiError
     */
    public criarEnderecoAdminApiDeliveryAdminEnderecosClienteClienteIdPost(
        clienteId: number,
     ...
     * @throws ApiError
     */
    public atualizarEnderecoAdminApiDeliveryAdminEnderecosClienteClienteIdEnderecoEnderecoIdPut(
        clienteId: number,
        enderecoId: number,
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/api/delivery/admin/enderecos/cliente/{cliente_id}/endereco/{endereco_id}',
            path: {
                'cliente_id': clienteId,
