...
export class ClientDeliveryMeiosDePagamentoService {
     ...
     * @throws ApiError
     */
    public listarMeiosPagamentoApiDeliveryClientMeiosPagamentoGet(
        xSuperToken: string,
    ): CancelablePromise<Array<MeioPagamentoResponse>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/delivery/client/meios-pagamento/',
            headers: {
