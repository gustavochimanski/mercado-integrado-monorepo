...
import { BannerCard } from "../parceiros/BannerCard";
import AdicionarBannerModal from "../parceiros/AdcionarBannerModal";
import AdicionarParceiroModal from "../parceiros/AdcionarParceiroModal";
